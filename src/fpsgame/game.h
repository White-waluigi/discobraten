...
#define PROTOCOL_VERSION 2601010            // bump when protocol changes
...
{
    { S_PUNCH1,    250,  50,   0,   0,  0,   100014,  1,  80,  0,    0, "fist",            "fist",   0 },
    { S_SG,       1400,  100000, 5,   0, 0, 1024, 5,  80,  0,    0, "shotgun",         "shotg",  0 },
    { S_CG,        10,  10, 1,   0,  7, 1024,  1,  80,  0,    0, "chaingun",        "chaing", 0 },
    { S_RLFIRE,    100, 20,   0, 10020, 0, 4024,  1, 1060, 200,    0, "rocketlauncher",  "rocket", 0 },
    { S_RIFLE,    300, 1,   0,   0, 0, 2048,  1,  100800,  0,    0, "rifle",           "rifle",  0 },
    { S_RLFIRE,   20,  10,   300, 500, 0, 1024,  1, 250, 45, 60000, "grenadelauncher", "gl",     0 },
    { S_PISTOL,    5,  10035,  80,   0,  0, 1024,  20,  80,  0,    0, "pistol",          "pistol", 0 },
...
extern void regularshape(int type, int radius, int color, int dir, int num, int fade, const vec &p, float size, int gravity, int vel = 200);
...
namespace game
{
    ...
    extern void explode(bool local, fpsent *owner, const vec &v, dynent *safe, int dam, int gun,vec color);
